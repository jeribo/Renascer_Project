...
class TypeAddressesControllerTest < ActionController::TestCase
  ...
  test "should create type_address" do
    assert_difference('TypeAddress.count') do
      post :create, type_address: { description: @type_address.description, inactevated_at: @type_address.inactevated_at }
    end
  ...
  test "should update type_address" do
    put :update, id: @type_address, type_address: { description: @type_address.description, inactevated_at: @type_address.inactevated_at }
    assert_redirected_to type_address_path(assigns(:type_address))
  end
